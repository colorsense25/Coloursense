...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030712] px-4 sm:px-6 lg:px-8 pt-18 pb-20">
      {/* Main About Section */}
      <motion.section 
        initial="hidden"
        animate="show"
      ...
      >
        <motion.div variants={item}>
          <h1 className="text-4xl sm:text-5xl font-bold text-rose-400 mb-4">
            About Color Sense
          </h1>
          <motion.p 
            variants={item}
            className="text-xl text-rose-300 font-medium mb-6"
          >
          ...
          >
            At Color Sense Salon, we blend artistry with cutting-edge techniques to create personalized beauty experiences. 
            Our passion for excellence and attention to detail ensures every client leaves feeling transformed, confident, 
            and radiant in our luxurious, contemporary space.
          </motion.p>
        </motion.div>
      </motion.section>
      ...
      <motion.section 
        ...
        className="bg-gradient-to-r from-gray-800 to-gray-900 py-16 text-center mb-12 rounded-xl mx-4 sm:mx-8 lg:mx-16 shadow-2xl border border-gray-700"
      >
        <motion.div 
          initial={{ scale: 0.95 }}
          whileInView={{ scale: 1 }}
        ...
        >
          <h2 className="text-3xl sm:text-4xl text-rose-300 italic mb-4">
            &ldquo;Beauty is not one-size-fits-all&rdquo;
          </h2>
          <p className="text-gray-400 text-base sm:text-lg uppercase tracking-wider">
            Customized Experiences • Premium Products • Exceptional Results
          </p>
        </motion.div>
      </motion.section>
      ...
      >
        <motion.h2 variants={item} className="text-center text-3xl sm:text-4xl font-bold text-rose-400 mb-4">
          Our Sanctuary
        </motion.h2>
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <motion.div 
            variants={item}
            className="bg-gray-800 p-6 rounded-xl shadow-lg text-center mb-8 max-w-3xl mx-auto border border-gray-700 hover:border-rose-400 transition-colors duration-300"
          >
          ...
          >
            ...
            <div className="relative rounded-xl shadow-lg overflow-hidden w-full h-full border border-gray-700">
              <iframe
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4 sm:px-8">
          ...
          <motion.div 
            variants={item}
            whileHover={{ y: -10 }}
            className="bg-gray-800 rounded-xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-gray-700 hover:border-rose-400"
          >
            ...
            <div className="p-6 text-center">
              <h3 className="text-xl font-semibold text-rose-300 mb-2">Sophia Rodriguez</h3>
          ...
          >
            ...
            <div className="p-6 text-center">
              <h3 className="text-xl font-semibold text-rose-300 mb-2">Emma Chen</h3>
          ...
          >
            <div className="relative pt-[100%] overflow-hidden">
              <Image
                src="https://res.cloudinary.com/dufxj1sau/image/upload/v1712345681/stylist3-dark.jpg"
                alt="Mia Johnson"
                fill
                className="object-cover hover:scale-105 transition-transform duration-500"
              />
            ...
            <div className="p-6 text-center">
              <h3 className="text-xl font-semibold text-rose-300 mb-2">Mia Johnson</h3>
              <p className="text-gray-400 text-sm font-medium">Skincare Expert</p>
          ...
          >
            ...
            <div className="p-6 text-center">
              <h3 className="text-xl font-semibold text-rose-300 mb-2">Olivia Martinez</h3>
